...
def quantity_selection_keyboard():
    return build_menu([back_btn("Back to Product", callback_data="back_to_product_details", style="danger")], n_cols=1)
...
def insufficient_balance_keyboard():
    return build_menu([back_btn("Back to Payment", callback_data="back_to_payment_method", style="danger")], n_cols=1)
...
def admin_cancel_keyboard():
    return build_menu([back_btn("Cancel", callback_data="admin_panel_back", style="danger")], n_cols=1)
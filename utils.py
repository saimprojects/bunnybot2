...
def quantity_selection_keyboard():
    return build_menu([
        back_btn(
            "Back to Product",
            callback_data="back_to_product_details",
            style="danger"
        )
    ], n_cols=1)
...
def wallet_payment_keyboard():
    return build_menu([
        btn(
            "Confirm & Pay",
            callback_data="confirm_wallet_payment",
            style="success",
            emoji_id=EMOJIS["confirm"]
        ),
        btn(
...
def support_keyboard():
    return build_menu([
        ...
        btn(
            "Announcements",
            url="https://t.me/bunnyhackss",
            style="primary",
            emoji_id=EMOJIS["announcement"]
        ),
        back_btn(
            "Back",
            callback_data="main_menu",
...
def admin_main_keyboard():
    buttons = [
        ...
        btn(
            "Bulk Products",
            callback_data="admin_bulk_add_products",
            style="success",
            emoji_id=EMOJIS["deposit"]
        ),
        btn(
            "Add Stock/Items",
            callback_data="admin_add_items",
            style="primary",
            emoji_id=EMOJIS["view_products"]
        ),
        btn(
            "Edit Price",
        ...
        btn(
            "Edit Stock",
            callback_data="admin_edit_stock",
            style="primary",
            emoji_id=EMOJIS["edit_stock"]
        ),
        btn(
            "Add Balance",
        ...
        btn(
            "Approve Withdrawal",
            callback_data="admin_approve_withdrawal",
            style="success",
            emoji_id=EMOJIS["confirm"]
        ),
        btn(
            ...
            style="danger",
            emoji_id=EMOJIS["broadcast"]
        ),
        btn(
            "Delete Product",
            callback_data="admin_delete_product",
            style="danger",
            emoji_id=EMOJIS["delete"]
        ),
        btn(
            "Order Details",
            callback_data="admin_order_details",
            style="primary",
            emoji_id=EMOJIS["order_details"]
        ),
        btn(
        ...
        btn(
            ...
            style="danger",
            emoji_id=EMOJIS["withdraw"]
        ),
        btn(
            "Stats",
            callback_data="admin_view_stats",
            style="success",
            emoji_id=EMOJIS["stats"]
        ),
    ]
